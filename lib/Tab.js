...
module.exports = class Tab {
    ...
    async inject() {
        ...
        // Inject base libary for tab
        const baseLib = fs.readFileSync(path.join(__dirname, 'Library.js'), 'utf8');
        // Inject code
        await this.execute(baseLib, true);
        // Get Menu.js libary
        let menuLib = fs.readFileSync(path.join(__dirname, 'Menu.js'), 'utf8');
        // Inject code
        console.log(await this.execute(menuLib, true));
    }

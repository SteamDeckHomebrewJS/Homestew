...
(() => {
    ...
    page.innerHTML += `
    <div style="width: 100%; height: 60px; border-top: 4px solid rgba(255,255,255,0.5); display: flex; justify-items: space-between; align-items: center;">
        <!-- VERSION -->
        <p style="margin: 10px; color: rgba(255,255,255,0.5);">${HOMESTEW_VERSION}</p>
        <!-- Reload Button -->
        <div class="Focusable" style="margin: 10px; width: 35px; height: 35px;" onclick="reloadPlugins">
